package com.engineering.microservice.awsdynamodb.configuration;
...
@Configuration
@EnableDynamoDBRepositories(basePackages = "com.engineering.microservice.awsdynamodb.repository")
